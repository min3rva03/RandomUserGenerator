...
class OnBoardingViewController: UIPageViewController {
    ...
    fileprivate(set) lazy var items: [OnBoardingItem] = {
        return [OnBoardingItem(
            ...
            description: "Personas interesantes alrededor del mundo",
            imageName: "LaunchScreen"
        ),
                OnBoardingItem(
                    title: "Conoce personas con tus mismos intereses",
                    description: "Presiona el boton para iniciar",
